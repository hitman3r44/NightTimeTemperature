...
@NoArgsConstructor
@Data
public class NightTimeTemperature {
  ...
  private Instant nautical_twilight_begin;
  ...
  public Instant getNautical_twilight_begin() {
    return nautical_twilight_begin;
  }

  public void setNautical_twilight_begin(Instant nautical_twilight_begin) {
