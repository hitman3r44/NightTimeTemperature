...
set JARPATH=%APP_HOME%\lib\NightTimeTemperature-0.0.1-SNAPSHOT-QA.jar

@rem Execute NightTimeTemperature
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %NIGHT_TIME_TEMPERATURE_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
